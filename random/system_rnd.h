 ...
 */
#if INT_MAX == 127
#define uint_swap(num)	(num)
#elif INT_MAX == 32767
#ifdef __bswap_16
#define uint_swap(num)	__bswap_16(num)
#else
#define uint_swap(num)									\
	((unsigned)(((unsigned)((num) >> 8) & 0x00FFU) |	\
				((unsigned)((num) << 8) & 0xFF00U)))
#endif
#elif INT_MAX == 2147483647
#ifdef __bswap_32
#define uint_swap(num)	__bswap_32(num)
#else
#define uint_swap(num)										\
	((unsigned)(((unsigned)((num) >> 24) & 0x000000FFU) |	\
...
#ifdef __bswap_64
#define uint_swap(num)	__bswap_64(num)
#else
#define uint_swap(num)												\
	((unsigned)(((unsigned)((num) >> 56) & 0x00000000000000FFU) |	\
...
#define uint2bigendian(num)	((unsigned)htonl((unsigned)(num)))
#define bigendian2uint(num)	((unsigned)ntohl((unsigned)(num)))
#elif HAVE_HTONL && HAVE_NTOHL && (INT_MAX == 32767)
#define uint2bigendian(num)	((unsigned)htons((unsigned)(num)))
#define bigendian2uint(num)	((unsigned)ntohs((unsigned)(num)))
#elif FTMGS_RUNTIME_ENDIAN
#define uint2bigendian(num)	((IS_LITTLE_ENDIAN()) ? uint_swap(num) : (num))
#define bigendian2uint(num)	((IS_LITTLE_ENDIAN()) ? uint_swap(num) : (num))
#elif FTMGS_LITTLE_ENDIAN
#define uint2bigendian(num)	uint_swap(num)
#define bigendian2uint(num)	uint_swap(num)
#elif FTMGS_PDP_ENDIAN
#error "Code not prepared for PDP endianness"
#else
#define uint2bigendian(num)	(num)
#define bigendian2uint(num)	(num)
#endif
/*----------------------------------------------------------------------------*/
#ifdef __cplusplus
extern "C" {
